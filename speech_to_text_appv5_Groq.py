...
def run_groq(user_message, model=Groq_model):
...
def speech_to_text(audio_file):
    ...
    audio_model="distil-whisper-large-v3-en"
    ...
    with open(audio_file, "rb") as file:
        ...
        transcription = client.audio.transcriptions.create(
          ...
          prompt="The audio conversation between 2 speakers",  # Optional
    ...
    dialog = chat_completion.choices[0].message.content
